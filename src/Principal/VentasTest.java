...
public class VentasTest {
    ...
    public static AccesoDatos guardado = new AccesoDatos();
...
//    indice me permite crear nuevos objetos de tipo Orden dentro del ArrayList
    ...
    public static void main(String[] args) {
        ...
        Producto p1 = new Producto("Monitor",75);
        Producto p2 = new Producto("Ratón",25);
        ...
        Orden ord1 = new Orden(lista);
        
       historialVenta.add(ord1);
       
        System.out.println(historialVenta);
    }
...
//                    in.nextLine();
//                    otroPro();
//                    System.out.println(historialVenta.get(indice).mostrarOrden(0));
//                    break;
//                case 2:
//                    
//                    in.nextLine();
...
//                    System.out.println("Pulse intro para continuar");
//                    guardado.agregarArchivo("HistorialVentas", historialVenta.toString());
//                    in.nextLine();
//                    indice++;
//                    break;
//                    
...
//    }
    ...
    public static String historial(ArrayList <Orden> historialVenta){
      String txt = "";
        for (int i = 0; i < historialVenta.size(); i++) {
            txt += historialVenta.get(i).toString();
        }
      return txt;
    }
}
